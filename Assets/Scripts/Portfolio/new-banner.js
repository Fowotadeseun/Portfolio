document.addEventListener('DOMContentLoaded', () => {
    ...
    const newProjectsIndices = [2, 7]; // Example indices for new project cards [0-3] first row, [4-7] second row
    const newBlogPostIndices = [0]; // Example indices for new blog posts [0-N] where N = n-1 blog pages
