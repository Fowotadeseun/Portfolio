...
<div class="hero-section">
  <div class="container">
    ...
    <h3>Statistics Expert | Data Scientist | AI & ML Researcher</h3>
    <p class="lead">
      Welcome! I'm a statistics expert with an M.S. in Statistics from Oregon State University and 5+ years of experience in statistical modeling, machine learning, and data science. Explore my projects showcasing advanced statistical methods, published research, and data-driven solutions across healthcare, genomics, and beyond.
    </p>
...
<div class="container">
  ...
  <div id="portfolioCarousel" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      ...
      <!-- Project 6: Diabetes Risk Prediction -->
      <div class="carousel-item">
        <div class="portfolio-card mx-auto" style="max-width: 800px;">
          <div class="badge-tag">Machine Learning</div>
          <img src="Assets/Images/diabetes.jpg" class="img-fluid mb-4" alt="Diabetes Risk Prediction">
          <h3 class="mb-3">Diabetes Risk Prediction Using Machine Learning</h3>
          <p class="px-3">
            Full ML pipeline comparing Logistic Regression, Random Forest, Gradient Boosting, and SVM for predicting diabetes risk — with ROC analysis, cross-validation, and feature importance using Python.
          </p>
          <a href="https://fowotadeseun.github.io/Portfolio/Content/Projects/Diabetes%20Risk%20Prediction/"
             target="_blank" rel="noopener noreferrer"
             class="cta-button mt-auto">See Project →</a>
        </div>
      </div>

      <!-- Project 7: COVID-19 Survival Analysis -->
      <div class="carousel-item">
        <div class="portfolio-card mx-auto" style="max-width: 800px;">
          <div class="badge-tag">Survival Analysis</div>
          <img src="Assets/Images/hospital_icu.jpg" class="img-fluid mb-4" alt="COVID-19 Survival Analysis">
          <h3 class="mb-3">COVID-19 Clinical Survival Analysis</h3>
          <p class="px-3">
          ...
          <a href="https://fowotadeseun.github.io/Portfolio/Content/Projects/COVID-19%20Survival%20Analysis/"
             target="_blank" rel="noopener noreferrer"
             class="cta-button mt-auto">See Project →</a>
        </div>
      </div>

      <!-- Project 8: Healthcare SQL Analytics -->
      <div class="carousel-item">
        <div class="portfolio-card mx-auto" style="max-width: 800px;">
          <div class="badge-tag">SQL · Data Engineering</div>
          <img src="Assets/Images/healthcare_data.jpg" class="img-fluid mb-4" alt="Healthcare SQL Analytics">
          <h3 class="mb-3">Healthcare Analytics: Hospital Readmission Pipeline</h3>
          <p class="px-3">
            End-to-end analytics pipeline using SQLite and Python to analyse 30-day hospital readmission patterns, cost drivers, and demographic disparities across 5,000 patient admissions.
          </p>
          <a href="https://fowotadeseun.github.io/Portfolio/Content/Projects/Healthcare%20SQL%20Analytics/"
             target="_blank" rel="noopener noreferrer"
             class="cta-button mt-auto">See Project →</a>
        </div>
      </div>
